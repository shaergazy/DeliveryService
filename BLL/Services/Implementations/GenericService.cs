...
{
    public class GenericService<TEntity, TKey, TListDto, TAddDto, TEditDto, TGetDto> : IGenericService<TEntity, TKey, TListDto, TAddDto, TEditDto, TGetDto>
   where TAddDto : class
   ...
   where TGetDto : class
       where TEntity : class
    {
        ...
        private readonly ILogger<GenericService<TEntity, TKey, TListDto, TAddDto, TEditDto, TGetDto>> _logger;

        public GenericService(IMapper mapper, IUnitOfWork<TEntity, TKey> unitOfWork, ILogger<GenericService<TEntity, TKey, TListDto, TAddDto, TEditDto, TGetDto>> logger)
        {
            _mapper = mapper;
